...
Chunk 10:
```{r}
#Categorizing age in different groups. (Change age to 60)
...
```
Chunk 33: Repeated can be updated
```{r}
...
strokepredict2 <- glm(stroke ~ gender + age + hypertension + heart_disease + ever_married + work_type + Residence_type + avg_glucose_level + bmi + smoking_status + sysBP + diaBP + OnAdmit_heartRate +age*hypertension + age*heart_disease + hypertension*heart_disease + heart_disease*smoking_status + hypertension*OnAdmit_heartRate + age*avg_glucose_level, data = Stroke_dataset, family="binomial")
