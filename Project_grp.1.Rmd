...
strokepredict <- glm(stroke ~ gender + age + hypertension + heart_disease + ever_married + work_type + Residence_type + avg_glucose_level + bmi + smoking_status + sysBP + diaBP + OnAdmit_heartRate + logbmi + logglucose, data = Stroke_dataset, family="binomial")
...
Chunk 37:
```{r}
#Additional safeguards to eliminate independent variables with high correlation amongst themselves
...
Chunk 40:
```{r}
#Improving the model by minimizing AIC value using Step AIC function
